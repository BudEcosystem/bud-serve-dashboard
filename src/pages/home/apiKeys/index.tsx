...
import CredentialsListTable from "@/components/ui/bud/table/CredentialsListTable";
    ...
    <DashBoardLayout>
      <div className="boardPageView">
        <div className="boardPageTop">
          <PageHeader headding="Credentials" />
        </div>
            ...
            items={[
              {
                label: <div className="flex items-center gap-[0.375rem]">
                  ...
                  {activeTab === "1" ?
                    <Text_14_600_EEEEEE >
                      Provider</Text_14_600_EEEEEE>
                    :
                    <Text_14_600_B3B3B3 >Provider</Text_14_600_B3B3B3>
                  }
                </div>,
                key: '1',
                children: <CredentialsListTable />
              },
              {
                label: <div className="flex items-center gap-[0.375rem]">
                  {activeTab === '2' ?
                  ...
                  {activeTab === "2" ?
                    <Text_14_600_EEEEEE >
                      Projects</Text_14_600_EEEEEE>
                    :
                    <Text_14_600_B3B3B3 >Projects</Text_14_600_B3B3B3>
                  }
                </div>,
                key: '2',
              ...
              },
              {
                label: <div className="flex items-center gap-[0.375rem]">
                  {activeTab === '3' ?
                    <div className="mt-[.1rem]">
                      <svg width=".875rem" height=".875rem" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M7.00586 1.42188C3.87125 1.42188 1.33398 3.95914 1.33398 7.09375C1.33398 10.2284 3.87125 12.7656 7.00586 12.7656C10.1405 12.7656 12.6777 10.2284 12.6777 7.09375C12.6777 3.95914 10.1405 1.42188 7.00586 1.42188ZM0.458984 7.09375C0.458984 3.47742 3.38953 0.546875 7.00586 0.546875C10.6222 0.546875 13.5527 3.47742 13.5527 7.09375C13.5527 10.7101 10.6222 13.6406 7.00586 13.6406C3.38953 13.6406 0.458984 10.7101 0.458984 7.09375Z" fill="#EEEEEE" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M7.00586 3.17188C7.24758 3.17188 7.44336 3.36765 7.44336 3.60938V7.09375C7.44336 7.33547 7.24758 7.53125 7.00586 7.53125C6.76414 7.53125 6.56836 7.33547 6.56836 7.09375V3.60938C6.56836 3.36765 6.76414 3.17188 7.00586 3.17188Z" fill="#EEEEEE" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M9.63086 7.09375C9.63086 7.33547 9.43508 7.53125 9.19336 7.53125H7.00586C6.76414 7.53125 6.56836 7.33547 6.56836 7.09375C6.56836 6.85203 6.76414 6.65625 7.00586 6.65625H9.19336C9.43508 6.65625 9.63086 6.85203 9.63086 7.09375Z" fill="#EEEEEE" />
                      </svg>
                    </div> :
                    <div className="mt-[.1rem]">
                      <svg width=".875rem" height=".875rem" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M7.00586 1.42188C3.87125 1.42188 1.33398 3.95914 1.33398 7.09375C1.33398 10.2284 3.87125 12.7656 7.00586 12.7656C10.1405 12.7656 12.6777 10.2284 12.6777 7.09375C12.6777 3.95914 10.1405 1.42188 7.00586 1.42188ZM0.458984 7.09375C0.458984 3.47742 3.38953 0.546875 7.00586 0.546875C10.6222 0.546875 13.5527 3.47742 13.5527 7.09375C13.5527 10.7101 10.6222 13.6406 7.00586 13.6406C3.38953 13.6406 0.458984 10.7101 0.458984 7.09375Z" fill="#B3B3B3" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M7.00586 3.17188C7.24758 3.17188 7.44336 3.36765 7.44336 3.60938V7.09375C7.44336 7.33547 7.24758 7.53125 7.00586 7.53125C6.76414 7.53125 6.56836 7.33547 6.56836 7.09375V3.60938C6.56836 3.36765 6.76414 3.17188 7.00586 3.17188Z" fill="#B3B3B3" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M9.63086 7.09375C9.63086 7.33547 9.43508 7.53125 9.19336 7.53125H7.00586C6.76414 7.53125 6.56836 7.33547 6.56836 7.09375C6.56836 6.85203 6.76414 6.65625 7.00586 6.65625H9.19336C9.43508 6.65625 9.63086 6.85203 9.63086 7.09375Z" fill="#B3B3B3" />
                      </svg>
                    </div>
                  }
                  {activeTab === "3" ?
                    <Text_14_600_EEEEEE >
                      Cloud Providers</Text_14_600_EEEEEE>
                    :
                    <Text_14_600_B3B3B3 >Cloud Providers</Text_14_600_B3B3B3>
                  }
                </div>,
                key: '3',
