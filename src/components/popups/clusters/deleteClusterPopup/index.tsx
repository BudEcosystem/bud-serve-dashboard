  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Content maxWidth="370px" className="w-[29%] p-[1.125rem] bg-[#111113] border-0 shadow-none">
        ...
        You’re about to delete <b>{itemName}</b> cluster from the entire repository . It will be deleted from the projects as well.
        </Text_12_400_787B83>
        <Flex gap="3" mt="4" justify="center">
          <ButtonInput className="w-full" onClick={onDelete}>Delete Cluster</ButtonInput>
        </Flex>
      </Dialog.Content>
    </Dialog.Root>
  );
