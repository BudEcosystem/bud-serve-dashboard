...
export default function WorkerDeleteStatus() {
        ...
        >
            <BudWraperBox>
                ...
                <CommonStatus
                    ...
                    events_field_id="delete_worker_events"
                    onCompleted={() => {
                        closeDrawer();
                    ...
                    success_payload_type="delete_worker"
                    title={"Deleting Worker"}
                    description="We are deleting the worker from the endpoint."
                />
            </BudWraperBox>
        </BudForm>
    );
