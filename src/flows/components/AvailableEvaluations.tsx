...
export function EvaluationCard({
    ...
    const { openDrawerWithExpandedStep, expandedStep } = useDrawer();
    ...
    return (
        <div
            ...
            className="py-[1rem] hover:bg-[#FFFFFF03] cursor-pointer hover:shadow-lg px-[1.4rem] border-b-[0.5px] border-t-[0.5px] border-t-[transparent] border-b-[#1F1F1F] hover:border-t-[.5px] hover:border-[#757575] flex-row flex border-box group"
        >
            <div className="flex justify-between items-start w-full">
                ...
                >
                    <div className="flex items-center justify-between w-full">
                        ...
                        <div className={`items-center text-[0.75rem] cursor-pointer text-[#757575] hover:text-[#EEEEEE] flex mr-[.6rem] whitespace-nowrap ${hideSeeMore ? 'hidden' : ''} opacity-0 group-hover:opacity-100`}
                            onClick={async (e) => {
                                e.stopPropagation();
                                if (expandedStep) return;
                                openDrawerWithExpandedStep("view-evaluation-details")
                            }}
                        >
